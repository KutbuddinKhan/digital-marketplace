...
const ThankPage = async ({ searchParams }: PageProps) => {
                ...
                <div className='lg:col-start-2'>
                    ...
                    {order._isPaid ? (
                        <p className="mt-2 text-base text-muted-foreground">
                            ...
                            available to download below. We&apos;ve sent your receipt and order details to{' '}
                            {typeof order.user !== "string" ? (
                        ...
                        <p className='mt-2 text-base text-muted-foreground'>
                            ...
                            currently processing it. So hang tight and we&apos;ll send you confirmation very soon!
                        </p>
                    )}
                    ...
                    <div className="mt-16 text-sm font-medium">
                        ...
                        <div className="space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="text-gray-900">{formatPrice(1)}</span>
                            </div>
